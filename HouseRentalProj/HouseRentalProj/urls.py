"""HouseRentalProj URL Configuration
...
from HouseRentalApp import views
...
urlpatterns = [
    ...
    path('houses/page/<int:page_number>', views.get_houses, name="houses Page"),
    path('house/<int:id>',views.get_house_info),
